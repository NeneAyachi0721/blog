  ...
  <div class="article-detail-container">
    <div class="article-content" v-loading="loading">
      <template v-if="article">
        ...
        <!-- 文章内容 -->
        <div
          class="article-body rich-text-content"
...
const checkUserInteractions = async () => {
  ...
  try {
    await request.get(
      `/article/${route.params.id}/like/status`,
      {},
      {
        showDefaultMsg: false,
        onSuccess: (data) => {
  ...
  try {
    await request.get(
      `/article/${route.params.id}/collect/status`,
      {},
      {
        showDefaultMsg: false,
        onSuccess: (data) => {
...
const handleCollect = async () => {
  ...
  try {
    await request.post(
      `/article/${route.params.id}/collect`,
      {},
      {
