<template>
  <div class="comment-management-container">
    ...
    <!-- 评论详情对话框 -->
    <el-dialog v-model="dialogVisible" title="评论详情" width="650px">
      <div class="comment-detail" v-if="currentComment">
        ...
        <div class="detail-item">
          ...
          <div class="content">
            <router-link
              :to="`/article/${currentComment.articleId}`"
              class="link-text"
              target="_blank"
            >
        ...
        <div class="detail-item">
          ...
          <div class="content user-info">
            ...
            ></el-avatar>
            <span>{{
              currentComment.userName || currentComment.username
            }}</span>
          </div>
        </div>
        <div class="detail-item">
        ...
        <div class="detail-item">
          ...
          <div class="content">
            <el-tag v-if="currentComment.status === 0" type="info"
              >待审核</el-tag
            >
            <el-tag v-else-if="currentComment.status === 1" type="success"
              >已通过</el-tag
            >
            <el-tag v-else-if="currentComment.status === 2" type="danger"
              >已拒绝</el-tag
            >
          </div>
        </div>
        ...
        <div class="detail-item" v-if="currentComment.isReply">
          ...
          <div class="content">
            {{ currentComment.parentContent || "无法获取父评论内容" }}
          </div>
        </div>

        <div
          class="detail-item"
          v-if="currentComment.isReply && currentComment.toUserName"
        >
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <el-button
            ...
            size="small"
            @click="
              handleAudit(currentComment.id, 1);
              dialogVisible = false;
            "
          >
            通过
          ...
          <el-button
            ...
            size="small"
            @click="
              handleAudit(currentComment.id, 2);
              dialogVisible = false;
            "
          >
            拒绝
