...
const fetchRecentArticles = async () => {
  ...
  try {
    await request.get('/article/recent', { size: 5 }, {
      showDefaultMsg: false,
      onSuccess: (data) => {
...
const fetchRecentComments = async () => {
  ...
  try {
    await request.get('/comment/recent', { size: 5 }, {
      showDefaultMsg: false,
      onSuccess: (data) => {
...
const fetchArticleTrend = async () => {
  ...
  try {
    await request.get('/dashboard/article/trend', {}, {
      showDefaultMsg: false,
      onSuccess: (data) => {
...
const fetchViewTrend = async () => {
  ...
  try {
    await request.get('/dashboard/view/trend', {}, {
      showDefaultMsg: false,
      onSuccess: (data) => {
